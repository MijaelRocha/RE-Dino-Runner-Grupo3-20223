...
class Game:
    ...
    def print_menu_elements(self):
        if self.death_count == 0:
            ...
            self.screen.blit(score_text, (SCREEN_WIDTH//2 - score_rect.width//2, SCREEN_HEIGHT//2 - score_rect.height//2))
            self.screen.blit(death_text, (SCREEN_WIDTH//2 - death_rect.width//2, SCREEN_HEIGHT//2 + death_rect.height//2))
